        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          >
            ...
            <p className="text-foreground/70 text-sm leading-relaxed">
              Protecting your digital DNA with cutting-edge cybersecurity solutions 
              and innovative threat detection technologies.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-primary font-semibold mb-6 tracking-wider">SERVICES</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-primary font-semibold mb-6 tracking-wider">EXPLORE</h3>
            <ul className="space-y-3">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-primary font-semibold mb-6 tracking-wider">CONNECT</h3>
            <ul className="space-y-3">
